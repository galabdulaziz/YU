  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5" style="background-color:darkgrey">
          <div class="card-body">
            ...
            <form class="form-signin" action="src/login_action.php" method="POST">
			  ...
			  <div class="form-label-group">
				...
				-->
			<div class="form-label-group">
                <input type="text" id="inputEmail" class="form-control" value ="" placeholder="Username" name="name" required autofocus>
              ...
              <hr class="my-4">
                <p style="text-align: center; font-weight: 500" class="lead">New? <a class="bodyLink" href="darkRegister.php">Sign up</a>!</p>
            </form>
          </div>
        </div>
      </div>
