...
<html lang="en">
  <head>
    ...
    <title>AlYamamah SWE Students Portfolio</title>
       <link rel="stylesheet" href="CSS/SWE-Style.css">
       <link rel="stylesheet" href="CSS/darkRegStyle.css">
  </head>
    
  <body style="background-color: #454d54">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card-signin flex-row my-5" style="background-color: darkgrey">
          <div class="card-body">
            ...
            <form class="form-signin" action="src/register_action.php" method="POST">
              ...
              <hr class="my-4">
                <p style="text-align: center; font-weight: 500" class="lead">Already have an account? <a class="bodyLink" href="darkLogin.html">Log in</a>!</p>
            </form>
          </div>
        </div>
      </div>
